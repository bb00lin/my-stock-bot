...
def sync_to_sheets(data_list):
    ...
    try:
        ...
        # 使用 USER_ENTERED 讓 Sheets 自動解析純數字
...
def fetch_pro_metrics(sid):
    ...
    try:
        ...
        # --- 1D 漲幅優化：改為純數字小數 (與殖利率欄位內容邏輯一致) ---
        d1_raw = (curr_p / df_hist['Close'].iloc[-2]) - 1
        
        chip_status = "🔴加碼" if d1_raw > 0 and inst_own > 30 else "🟢觀望"
